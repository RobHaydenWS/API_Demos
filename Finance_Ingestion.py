...
#Fifth, DELETE all existing Annual Data
...
#Seventh: delete any Holdings data
...
merged_annual_data_df = pd.merge(annual_data_df, asset_lookups_df, left_on='Asset', right_on='assetCorporateId',
                                 how='left')
...
funds_merged_annual_data_df.rename(
    columns={'Year [Required]': 'year', 'Asset class [Required]': 'assetClass', 'Currency [Required]': 'currencyCode',
             'Outstanding amount [Required]': 'outstandingAmountNative'}, inplace=True)
